...
local bkgMusic = audio.loadSound("level1Music.wav")
...
local function bkgMusic()
    ...
    timer.performWithDelay(13000, bkgMusic, 0)
end
...
local function DetermineAlternateAnswers()    
    ...
    alternateAnswer1 = correctAnswer + math.random(10, 15)
    ...
    -- generate incorrect answer and set it in the textbox
    alternateAnswer3 = correctAnswer + math.random(1, 9)
...
local function CheckUserAnswerInput()
    if (userAnswer == correctAnswer) then 
        ...
        timer.performWithDelay(1000, CheckWinOrLose)
...
function scene:create( event )
    ...
    answerbox = display.newText("", display.contentWidth * 0.1, 0, nil, 190)
    alternateAnswerBox1 = display.newText("", display.contentWidth * 0.1, 0, nil, 120)
    alternateAnswerBox2 = display.newText("", display.contentWidth * 0.1, 0, nil, 80)
    alternateAnswerBox3 = display.newText("", display.contentWidth * 0.1, 0, nil, 120)
